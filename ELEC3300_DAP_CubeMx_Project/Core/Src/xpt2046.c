...
// call this only if ucXPT2046_TouchFlag == 1
strType_XPT2046_Coordinate getTouchedPoint(void) {
	strType_XPT2046_Coordinate strDispCoor = {0, 0};
	XPT2046_Get_TouchedPoint(&strDispCoor, &strXPT2046_TouchPara);
	return strDispCoor;
}
